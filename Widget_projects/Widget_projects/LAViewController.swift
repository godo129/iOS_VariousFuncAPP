//
//  LAViewController.swift
//  Widget_projects
//
//  Created by comsoft on 2021/06/13.
//

import UIKit
import AVFoundation

class LAViewController: UIViewController {

    @IBOutlet weak var weatherText: UILabel!
    
    let weatherAPI_URL = "https://api.openweathermap.org/data/2.5/weather?q=Los%20Angeles&appid=6133de20ded927279482a432889cab72"
    ...
    override func viewDidLoad() {
        ...
        let path = Bundle.main.path(forResource: "LA", ofType: "mp4")!
    ...
    func inputImageToLabel(weatherInfos: String, icon: String) {
        ...
        //정렬
        self.weatherText.textAlignment = .center
        //레이블에 내용 뿌려주기
