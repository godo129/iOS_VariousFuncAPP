...
class ParisViewController: UIViewController {
    ...
    let weatherAPI_URL = "https://api.openweathermap.org/data/2.5/weather?q=Paris&appid=6133de20ded927279482a432889cab72"
    ...
    override func viewDidLoad() {
        ...
        let path = Bundle.main.path(forResource: "Paris", ofType: "mp4")!
