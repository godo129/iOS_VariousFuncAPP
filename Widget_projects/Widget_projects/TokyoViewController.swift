...
class TokyoViewController: UIViewController {
    ...
    let weatherAPI_URL = "https://api.openweathermap.org/data/2.5/weather?q=Tokyo&appid=6133de20ded927279482a432889cab72"
    ...
    override func viewDidLoad() {
        ...
        let path = Bundle.main.path(forResource: "Tokyo", ofType: "mp4")!
